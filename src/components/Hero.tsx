...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-red-600 via-red-700 to-black">
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
            ...
            <span className="text-red-300">Estrutura</span> — Não de Sorte.
          </h1>
          ...
          <button
            ...
            className="inline-block px-12 py-5 bg-white text-red-600 text-lg font-bold rounded-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-200 shadow-2xl mb-16"
          >
              ...
              {!hasPlayed && (
                <div className="absolute inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center">
                  <div className="text-center">
                    <button
                      onClick={handlePlay}
                      className="w-24 h-24 md:w-28 md:h-28 bg-red-600 rounded-full flex items-center justify-center mx-auto shadow-2xl hover:bg-red-500 active:scale-95 transition-transform"
