      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-16 max-w-7xl mx-auto">
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-red-600 rounded-full blur-3xl opacity-20"></div>
            
            <div className="relative group">
              <div className="absolute inset-0 bg-red-600 rounded-2xl rotate-3 group-hover:rotate-2 transition-transform duration-300 opacity-20"></div>
              <img 
                src={teamImage} 
                alt="Equipe Eixo" 
          ...
          <div className="w-full lg:w-1/2">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-50 rounded-full text-red-600 font-semibold text-sm mb-6">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
              Venha fazer parte do time que <span className="text-red-600 relative">
                mais cresce
            ...
            <button 
              ...
              className="group bg-red-600 hover:bg-red-700 text-white text-lg font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-red-500/30 transition-all duration-300 flex items-center gap-3 w-full sm:w-auto justify-center"
            >
              Quero Fazer Parte
